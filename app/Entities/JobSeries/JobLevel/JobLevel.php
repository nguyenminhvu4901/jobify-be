...
class JobLevel extends BaseModel implements Transformable
{
    ...
    protected function title(): Attribute
    {
        return Attribute::make(
            get: fn (string $value) => ($t = __('data/job_series/job_levels.title.'.$value)) !==
    ...
    {
        return Attribute::make(
            get: fn (string $value) => translatable_or_original('data/job_series/job_levels.description', $value)
        );
    }
}

...
{
    use BusinessSectorRelationship;
    use HasFactory;
    ...
    protected function name(): Attribute
    {
        return Attribute::make(
            get: fn (string $value) => translatable_or_original('data/company_series/business_sectors.name', $value)
        );
    }
    ...
    {
        return Attribute::make(
            get: fn (string $value) => translatable_or_original('data/company_series/business_sectors.description', $value)
        );
    }
}
